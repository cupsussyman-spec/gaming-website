    ...
    <div style={{ minHeight: '100vh', paddingBottom: '80px', position: 'relative' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <a
            href="https://www.instagram.com/uw.rishi/"
            target="_blank"
            rel="noopener noreferrer"
            style={{
              display: 'flex',
            ...
            onMouseEnter={e => {
              e.currentTarget.style.background = 'rgba(131, 58, 180, 0.5)';
              e.currentTarget.style.boxShadow = '0 0 16px rgba(225,48,108,0.5)';
            }}
            onMouseLeave={e => {
              e.currentTarget.style.background = 'rgba(131, 58, 180, 0.25)';
              e.currentTarget.style.boxShadow = '0 0 10px rgba(225,48,108,0.2)';
            }}
          >
            <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor">
